      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="inline-block mb-4">
              <Image 
                ...
                width={150} 
                height={45}
                className="brightness-200" // Para deixar o logo branco no fundo escuro
              />
            </Link>
            <p className="text-gray-300 text-sm">
              Uma vida sem fronteiras. Explore o mundo virtual da 3D Life Virtual, onde a realidade encontra o digital.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4">
              <h4 className="text-sm font-medium mb-2">Siga-nos</h4>
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} 3D Life Virtual. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
